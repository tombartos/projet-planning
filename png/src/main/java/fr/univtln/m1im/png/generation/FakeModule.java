...
record FakeModule(String code, String nom, String description) {
        ...
        static final FakeModule MODULE_ALGORITHMIQUE = new FakeModule("INF102", "Algorithmique",
        ...
        static final FakeModule MODULE_PSYCHOLOGIE_DEVELOPPEMENT = new FakeModule("PSY102",
